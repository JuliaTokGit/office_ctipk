(function($) {
    ...
    Pages.prototype.initInputFile = function() {
        ...
        $('.btn-file :file').on('fileselect', function(event, numFiles, label) {
            ...
            if( input.length ) {
                ...
                // console.log('sadax');
                $(this).parent().find('.text').html(log);
            }
        });        
    }   
    ...
    */
    ...
    Pages.prototype.initDatepickerPlugin = function() {
        $.fn.datepicker && $('[data-init-plugin="datepicker"]').each(function() {
            $(this).datepicker({
                format: 'dd-mm-yyyy',
                todayHighlight:true, 
                language: 'ru'
    ...
    * @requires select2.js
    */
    Pages.prototype.initSelect2AjaxPlugin = function() {
        $.fn.select2 && $('[data-init-plugin="select2ajax"]').each(function() {
    ...
    /** @function initSelect2Plugin
    * @description Initialize select2 dropdown
    * @requires select2.js version 4
    */
    Pages.prototype.initSelect2NewPlugin = function() {
        $.fn.select2 && $('[data-init-plugin="select2new"]').each(function() {
            $(this).select2({
    ...
    Pages.prototype.initTooltipsterPlugin = function() {
        $.fn.tooltipster && $('[data-init-plugin="tooltipster"]').each(function() {
            $(this).tooltipster({
            })
        });
    }
    ...
    /** @function initSummernote Plugin
    * @description Initialize Summernote  dropdown
    * @requires Summernote .js
    */
    Pages.prototype.initSummernotePlugin = function() {
    $('[data-init-plugin="summernote"]').each(function() {
            $(this).summernote({
            height: 150,
            lang: 'ru-RU',
            dialogsInBody: true,
            ...
            popover: {
                        ...
                        toolbar: [
                            ...
                            ['insert',['link','hr','databasic','mymodal']],
    ...
    */
    Pages.prototype.init = function() {
        ...
        this.initSelect2NewPlugin();
        this.initSummernotePlugin();
