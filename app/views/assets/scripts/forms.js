...
{return `<div class="btn-group"><a href="/form/id/${data}" type="button" class="btn btn-primary">Редактировать</a><a href="/product/id/${data}" type="button" class="btn btn-primary">Просмотреть</a></div>`}
